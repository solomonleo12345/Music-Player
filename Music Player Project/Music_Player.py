...
def play_time():
  ...
  bottom_timeline1.config(text=current_time)
...
def play_normal():
  ...
  for i in song_name_list:
    if song == i:
      ...
      '''song_list2.selection_clear(0, END)
      song_list2.activate(name_index+1)'''
    #song_list2.selection_clear()
    #song_list2.see(ACTIVE)
'''song_list2.selection_set(name_index+1, last=None)'''
...
slider_label = Label(walker_frame, text='0')
slider_label.place(x=10, y=510, width=200, height=20)
